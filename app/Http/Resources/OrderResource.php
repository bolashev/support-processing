...
class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'statusLabel' => $this->order_status->label(),
            'statusType' => $this->mapStatusType(),
            'stateLabel' => $requestStatus->label(),
            'stateColor' => $this->mapStateColor($requestStatus),
            'timerLabel' => $this->getTimerLabel($requestStatus),
            'timer' => $this->getTimer($requestStatus),
            'timerColor' => $this->getTimerColor($requestStatus),
            'manager' => $this->whenLoaded('manager', fn () => $this->manager->name),
            'isSelf' => $this->manager_id === $request->user()?->id,
