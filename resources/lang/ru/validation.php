...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'inn' => 'ИНН',
        'site' => 'Сайт',
        'old_service' => 'Сколько лет сервису',
        'certificate' => 'Наличие сертификатов и допусков',
        'certificate_other' => 'Наличие сертификатов и допусков (другое)',
        'arrival_time' => 'Интервал времени приезда сервисного специалиста после после получения заявки на ремонт',
        'main_profile' => 'Основной профиль, специфика',
        'tool' => 'Обеспеченность основными материалами для производства работ, наличие инструмента',
        'has_car' => 'Обеспеченность транспортными средствами',
        'business_trips' => 'Возможность выезда в ближайшие города, командировки до нескольких дней (не более недели)',
        'projects' => 'Наличие крупных клиентов, значимых проектов',
        'tax_system' => 'Форма налогообложения',
        'count_employees' => 'Количество сервисных сотрудников',
        'regulations' => 'Ознакомлен с регламентом взаимодействия с ООО «Наладил.ру»',
